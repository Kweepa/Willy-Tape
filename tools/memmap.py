...
TAPE_RAM = [
    ...
    ("guardian_udgs chr 24+", 0x18C0, 288, "runtime UDG workspace (6 x 6 chr)"),
    ("player_udg chr 60+", 0x19E0, 48, "runtime Willy composite (6 chr; 64-65 @ $1A00)"),
    ("resident arrows chr 66+", 0x1A10, 16, "PRG-resident arrow + HUD icon patterns"),
    ("font_glyphs chr 70+", 0x1A30, 472, "PRG-resident propfont subset (59 x 8 B)"),
